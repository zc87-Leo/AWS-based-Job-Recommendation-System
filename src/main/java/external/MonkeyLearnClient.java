...
public class MonkeyLearnClient {
	private static final String API_KEY = "fa42f6932c6af2efc29822799d19e125cf94cd02";// make sure change it to your api key.
	...
	private static List<List<String>> getKeywords(JSONArray mlResultArray) {
		...
		for (int i = 0; i < mlResultArray.size(); ++i) { // i represents 20 job description
			List<String> keywords = new ArrayList<>();
			JSONArray keywordsArray = (JSONArray) mlResultArray.get(i);
			for (int j = 0; j < keywordsArray.size(); ++j) { // every job description has j words
